...
export default function Rose({ navigation }) {
  ...
  return (
    ...
    <AntDesign name="leftcircleo" size={30} color="black" /> 
        ...
        <Text style={{ marginTop : 2, fontSize: 30, fontWeight: 'bold',alignSelf:'center'}}>Rose</Text>
        <Image source={require('../assets/rose.png')} style={{width:screenwidth,height:200, margin : 10}} resizeMode='contain'></Image> 
        <Text style={{fontSize:15,textAlign:'center',color:'grey',borderRadius:20, padding:20,borderWidth:2}}>A rose is either a woody perennial flowering plant of the genus Rosa (/ˈroʊzə/) in the family Rosaceae or the flower it bears. There are over three hundred species and tens of thousands of cultivars. They form a group of plants that can be erect shrubs, climbing, or trailing, with stems that are often armed with sharp prickles.Their flowers vary in size and shape and are usually large and showy, in colours ranging from white through yellows and reds. Most species are native to Asia, with smaller numbers native to Europe, North America, and northwestern Africa</Text>
  <View style={{flexDirection:'row',justifyContent:'space-around'}}>
  <View >
  <Text style={{fontSize:15,fontWeight:'bold',padding:5}}>Water</Text>
  <Text style={{backgroundColor:'lightblue',borderRadius:30,width:100,padding:5}}>2-3 time a week.</Text>
  </View>

   <View >
  <Text style={{fontSize:15,fontWeight:'bold',padding:5}}>Illumination</Text>
  <Text style={{backgroundColor:'lightblue',borderRadius:30,width:200,padding:5}}>Full sun</Text>
  </View>
  </View>
  ...
  <Text style={{backgroundColor:'lightblue',borderRadius:30,width:100,padding:5}}>60F-70F</Text>
  </View>

   <View >
  <Text style={{fontSize:15,fontWeight:'bold',padding:5}}>Fertilizers</Text>
  <Text style={{backgroundColor:'lightblue',borderRadius:30,width:200,padding:5}}>Every 4-6 weeks.</Text>
  </View>
  </View>
